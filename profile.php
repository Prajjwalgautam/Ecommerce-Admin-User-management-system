                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="profile-header text-center">
                                    <img src="https://ui-avatars.com/api/?name=<?= urlencode($user['firstname'] . '+' . $user['lastname']) ?>&size=150&background=random"
                                ...
                                <div class="profile-details">
                                    <div class="detail-item">
                                        ...
                                        <div class="detail-value"><?= htmlspecialchars($user['firstname']) ?></div>
                                    </div>

                                    <div class="detail-item">
                                        <div class="detail-label">Last Name</div>
                                        <div class="detail-value"><?= htmlspecialchars($user['lastname']) ?></div>
                                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/partials/code.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
