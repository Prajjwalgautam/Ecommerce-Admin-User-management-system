...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == UPLOAD_ERR_OK) {
        ...
        $file_firstname = 'profile_' . $user_id . '_' . time() . '.' . $file_ext;
        $file_path = $upload_dir . $file_firstname;
...
// Fetch user data from ecommerce table
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- HTML form remains the same as in previous example -->
                ...
                <body>
                    <div class="profile-container">
                        ...
                        <?php endif; ?>
                        <?php include("partials/profileform.php"); ?>
