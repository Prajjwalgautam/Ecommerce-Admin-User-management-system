<form method="POST" enctype="multipart/form-data" id="profileForm">
    ...
    <div class="form-group">
        ...
        <input type="text" id="name" name="firstname" value="<?php echo htmlspecialchars($user['firstname'] ?? ($user['firstname'] ?? '')); ?>" required disabled>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($user['email'] ?? ($user['email'] ?? '')); ?>" required disabled>
    </div>

    <div class="form-group">
        <label for="number">Phone Number</label>
        <input type="text" id="number" name="number" value="<?php echo htmlspecialchars($user['number'] ?? ''); ?>" disabled>
    </div>
